...
#     if num_xticks == 3:  
    axi.set_xticks(np.arange(xmin + xtick_offset, xmin + xtick_offset + num_xticks*30, (xmin + xtick_offset + num_xticks*30 - (xmin + xtick_offset))/num_xticks), crs=ccrs.PlateCarree())
#     axi.set_xticks(np.arange(xmin + xtick_offset, xmax, (xmax - (xmin + xtick_offset))/num_xticks), crs=ccrs.PlateCarree())
